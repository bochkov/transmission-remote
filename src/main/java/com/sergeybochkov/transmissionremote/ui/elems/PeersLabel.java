...
import com.sergeybochkov.transmissionremote.model.HumanSpeed;
...
public final class PeersLabel {
    ...
    public PeersLabel(int sendToUs, int getFromUs, int connected,
                      double rateDownload, double rateUpload) {
