...
public class Settings {
    ...
    public static final String appName = "Transmission Remote";
    public static final String emptyString = "";

    public static final String fontAwesome = "/style/fontawesome-webfont.woff";
    public static final String settingsDir = System.getProperty("user.home") + File.separator + ".transmissionremote";
